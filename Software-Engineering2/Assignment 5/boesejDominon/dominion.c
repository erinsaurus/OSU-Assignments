...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
  ...
  switch (card) {
    ...
    case village:
      ...
      refactoredVillage(currentPlayer, handPos, state);
    ...
    case steward:
      ...
      refactoredSteward(choice1, choice2, choice3, currentPlayer, handPos, state);
    ...
    case ambassador:
      ...
      return refactoredAmbassador(handPos, choice1, choice2, choice3, currentPlayer, state);
