...
int main() {
  ...
  /*  Book b1("123", "War and Peace", "Tolstoy");
    ...
    for (int i=0; i<7; i++)
     ...
     cout << "It is day 7" << endl;
    
    lib.checkOutBook("bcd", "123");
    
    cout << "b1 should be checked out" << endl;
    
    if (b1.getLocation() == CHECKED_OUT) //p2 checks out b1
    {
        cout << "b1 is checked out!" << endl;
    }
   
    cout << "p1's fine should be $0.00: "
    << p1.getFineAmount() << endl;
    
    cout << "p2's fine should be $0.00: "
    << p2.getFineAmount() << endl;
    
    for(int i=0; i<15; i++)
        lib.incrementCurrentDate();
    
    cout << "It is now day 22" << endl;
    
    lib.checkOutBook("abc", "345");
    
    cout << "b3 should be checked out" << endl;
    
    if (b3.getLocation()==CHECKED_OUT) //p1 checks out b3
    {
        cout << "b3 is checked out!" << endl;
    }
    
    cout << "p1's fine should be $0.00: " // not overdue
    << p1.getFineAmount() << endl;
    cout << "p2's fine should be $0.10: "//1 day overdue
    << p2.getFineAmount() << endl;
    
    for (int i=0; i<24; i++)
        lib.incrementCurrentDate();
    
    cout << "It is now day 46" << endl;
    cout << "p1's fine should be $0.30: " //3 days overdue
    << p1.getFineAmount() << endl;
    cout << "p2's fine should be $1.80: " //18 days overdue
    << p2.getFineAmount() << endl;
    
    cout << "p2 pays $0.20 fine" << endl;
    
    lib.payFine("bcd", 0.2);
    
    cout << "p2's fine should now be $0.10: " 
     << p2.getFineAmount() << endl;
   */
...
/*    Book b1("123", "War and Peace", "Tolstoy");
    ...
    cout << "p2 just paid $0.50 in fines" << endl;
    cout << "p1's total fine amount should be $0.30: "
    << p1.getFineAmount() << endl;
    cout << "p2's total fine amount should be $0.80: "
    << p2.getFineAmount() << endl;
